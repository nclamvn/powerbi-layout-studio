        ...
        {visualTypes.map((type) => {
          ...
          return (
            <button
              ...
              className="group flex flex-col items-center gap-2 p-4 bg-dark-surface/50 rounded-xl border border-white/5 hover:bg-dark-surface hover:border-primary-500/30 transition-all cursor-pointer"
            >
              ...
              <span className="text-xs text-white/70 group-hover:text-white text-center">
                {VISUAL_LABELS[type]}
              </span>
            </button>
          );
